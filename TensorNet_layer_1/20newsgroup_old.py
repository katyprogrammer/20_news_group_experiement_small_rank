...
'''
os.environ['THEANO_FLAGS'] = 'device=cpu, assert_no_cpu_op=raise, on_unused_input=ignore, floatX=float32, lib__cnmem=0.45, dnn.conv.algo_fwd=time_once,  dnn.conv.algo_bwd=time_once'
def parse_arg():
...
def main(num_epochs=2000,fin_params=None,fout_params=None,A_B=None, rank=None):
    # Load the dataset
    print("Loading data...")
